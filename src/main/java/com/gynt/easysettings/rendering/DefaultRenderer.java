...
import com.gynt.easysettings.api.*;
...
public class DefaultRenderer implements Renderer {
        ...
        switch (setting.getType().getType().toUpperCase()) {
            ...
            case "INTEGER": {
                JSpinner js = new JSpinner(
                        new SpinnerNumberModel((int) setting.getValue(), null, null, new Integer(1)));
            ...
            case "DOUBLE": {
                JSpinner js = new JSpinner(
                        new SpinnerNumberModel((double) setting.getValue(), null, null, new Double(1)));
                js.addChangeListener(new ChangeListener() {
            ...
            case "BOOLEAN": {
                ...
                jcb.setSelected(setting.getValue() != null && (boolean) setting.getValue());
    ...
    public JFileChooser renderFileDialog(Setting setting) {
        ...
        if (setting.getType().getType().equalsIgnoreCase("FOLDER")) {
